...
const from = document.getElementById('quiz-form')
...
// to create a new array containing only the elements of the original array that satisfy a specified condition
